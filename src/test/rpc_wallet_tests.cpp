...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CFacileCoinAddress demoAddress = CFacileCoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CFacileCoinAddress setaccountDemoAddress = CFacileCoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CFacileCoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CFacileCoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
