...
/** FacileCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class FacileCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit FacileCoinUnits(QObject *parent);
...
typedef FacileCoinUnits::Unit FacileCoinUnit;
