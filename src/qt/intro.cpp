...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/facilecoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("FacileCoin Core"),
     ...
     * override -datadir in the facilecoin.conf file in the default data directory
     * (to be consistent with facilecoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
