...
With the client installed we'll proceed to download the blockchain torrent file. Use the following magnet link:
 ...
 or go to [Jeff Garzik's topic](https://facilecointalk.org/index.php?topic=145386.0) for a signed magnet link. Alternatively you can use the [.torrent file](http://sourceforge.net/projects/facilecoin/files/FacileCoin/blockchain/bootstrap.dat.torrent/download) found on SourceForge.
...
Open Finder by pressing Press [shift] + [cmd] + [g] and enter:
	...
	~/Library/Application Support/FacileCoin/
...
### Importing the blockchain
Now start the FacileCoin client software. It should show "Importing blocks from disk" like the image below. 
