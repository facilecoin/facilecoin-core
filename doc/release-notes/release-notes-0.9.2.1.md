FacileCoin Core version 0.9.2.1 is now available from:

  https://facilecoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 FCN to 0.01 FCN
...
- Fix "Start facilecoin on system login"
