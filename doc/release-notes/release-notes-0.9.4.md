FacileCoin Core version 0.9.4 is now available from:

  https://facilecoin.org/bin/0.9.4/
...
this update is incompatible with the FacileCoin system and could lead to consensus
forks.

FacileCoin Core released binaries from https://facilecoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~facilecoin/+archive/ubuntu/facilecoin
- A third-party or self-compiled FacileCoin Core

upgrade to FacileCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
