FacileCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/facilecoin/files/FacileCoin/facilecoin-0.5.4/
...
http://gitorious.org/facilecoin/facilecoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix FacileCoin-Qt notifications under Growl 1.3.
Increase required age of FacileCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxFacileCoin properly when installing FacileCoin-Qt over it. (Windows)
