FacileCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/facilecoin/files/FacileCoin/facilecoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the FacileCoin
...
New/changed settings (command-line or facilecoin.conf file)
--------------------------------------------------------
