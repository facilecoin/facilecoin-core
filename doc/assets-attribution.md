The following is a list of assets used in the facilecoin source and their proper attribution.
...
* License: MIT
* Site: [https://facilecointalk.org/index.php?topic=15276.0](https://facilecointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original facilecoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/facilecoin.icns, src/qt/res/src/facilecoin.svg,
	src/qt/res/src/facilecoin.ico, src/qt/res/src/facilecoin.png,
	src/qt/res/src/facilecoin_testnet.png, docs/facilecoin_logo_doxygen.png,
